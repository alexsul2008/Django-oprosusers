# Generated by Django 4.0 on 2023-08-01 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otv', models.IntegerField(default=0, null=True, verbose_name='Ответ')),
                ...
                ('vop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_answer_vop', to='questions.questions', verbose_name='Вопрос в ответе')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_questions', to='questions.questions')),
            ],
            options={
                'verbose_name': 'Ответ',
